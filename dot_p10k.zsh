# Generated by Powerlevel10k configuration wizard on 2024-08-04 at 17:14 MST.
...
() {
  ...
  # Remove the right prompt's default indent
  ...
  typeset -g POWERLEVEL9K_VI_MODE_VISUAL_FOREGROUND=2
